...
[deleteMigratedLedger]
delete from etracs25_migrate_rptledger
...
[deleteLedgerPayment]
delete from etracs25_migrate_rptledgerpayment
...
where not exists(select * from etracs25_migrate_rptledgerpayment where objid = rl.objid)
